# Performance Baseline — phase0-after

Captured: 2026-04-25T06:44:49Z
...
| Metric | Value |
|---|---|
| `cargo build --release` time (s) | 16 |
| Binary size (KB) | 2372 |
| `server/src/main.rs` LOC | 6 |
| `server/src/lib.rs` LOC | 2867 |
| Full test suite duration (ms) | 1695 |
...
| GET /api/health | 1 | 30 |
| GET /api/cwd | 16 | 20 |
| GET /api/tmux/list | 20 | 20 |
| GET /api/tmux/pane-mode | 23 | 20 |
